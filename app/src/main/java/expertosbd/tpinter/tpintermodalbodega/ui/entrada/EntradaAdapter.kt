...
class EntradaAdapter(val context: Context, private val items: MutableList<Evento>,
                     fragment: Fragment) :
        RecyclerView.Adapter<EntradaAdapter.EventoViewHolder>(), Filterable {

    private val listener: EntradaAdapter.OnItemClickListener
    private var filteredList: MutableList<Evento>

    init {
        this.listener = fragment as EntradaAdapter.OnItemClickListener
        filteredList = items
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EventoViewHolder {
        ...
        return EntradaAdapter.EventoViewHolder(itemView)
    }
